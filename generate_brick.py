...
G.add((PROP.value, RDFS.subPropertyOf, QUDT.value))
G.add((PROP.value, SKOS.definition, Literal("The basic value of an entity property")))
G.add((PROP.unit, A, OWL.ObjectProperty))
G.add((PROP.unit, RDFS.subPropertyOf, QUDT.unit))
G.add((PROP.unit, SKOS.definition, Literal("The units of the entity property value")))
