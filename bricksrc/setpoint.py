...
setpoint_definitions = {
    "Setpoint": {
        "tags": [TAG.Setpoint],
        "subclasses": {
            "Enthalpy_Setpoint": {"tags": [TAG.Setpoint, TAG.Enthalpy],},
            "Dew_Point_Setpoint": {"tags": [TAG.Dewpoint, TAG.Setpoint],},
            "Demand_Setpoint": {
            ...
            "Humidity_Setpoint": {"tags": [TAG.Humidity, TAG.Setpoint],},
            "Load_Setpoint": {
                "subclasses": {
                    "Load_Shed_Setpoint": {
            ...
            "Luminance_Setpoint": {"tags": [TAG.Luminance, TAG.Setpoint],},
            "Mode_Setpoint": {
                "subclasses": {
