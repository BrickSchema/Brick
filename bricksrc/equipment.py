...
hvac_subclasses = {
    ...
    "Separation_Tube": {"tags": [TAG.Gas, TAG.Liquid, TAG.Distribution, TAG.Equipment]}, 
    "Accumulator": {"tags": [TAG.Equipment, TAG.Accumulator]},
...
hvac_valve_subclasses = {
    ...
    "Electronic_Expansion_Valve": {"tags": [TAG.Valve, TAG.Equipment]},
    "Check_Valve": {"tags": [TAG.Valve, TAG.Equipment]},
    "Solenoid_Valve": {"tags": [TAG.Valve, TAG.Equipment]},
