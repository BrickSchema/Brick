...
alarm_definitions = {
    "Alarm": {
        "tags": [TAG.Alarm],
        "subclasses": {
            "Air_Alarm": {"tags": [TAG.Air, TAG.Alarm],},
            "CO2_Alarm": {
                "tags": [TAG.CO2, TAG.Alarm],
                "subclasses": {
                    "High_CO2_Alarm": {"tags": [TAG.High, TAG.CO2, TAG.Alarm],},
                },
            },
            "Change_Filter_Alarm": {"tags": [TAG.Change, TAG.Filter, TAG.Alarm],},
            ...
            "Cycle_Alarm": {
                ...
                "subclasses": {
                    "Short_Cycle_Alarm": {"tags": [TAG.Short, TAG.Cycle, TAG.Alarm],},
                },
            },
            "Emergency_Alarm": {
            ...
            "Failure_Alarm": {
                ...
                "subclasses": {
                    "Unit_Failure_Alarm": {"tags": [TAG.Unit, TAG.Failure, TAG.Alarm],},
                },
            },
            "Humidity_Alarm": {
                ...
                "subclasses": {
                    ...
                    "Low_Humidity_Alarm": {"tags": [TAG.Low, TAG.Humidity, TAG.Alarm],},
                },
            },
            "Leak_Alarm": {
            ...
            "Liquid_Detected_Alarm": {"tags": [TAG.Liquid, TAG.Detected, TAG.Alarm],},
            "Luminance_Alarm": {"tags": [TAG.Luminance, TAG.Alarm],},
            "Maintenance_Required_Alarm": {
                "tags": [TAG.Maintenance, TAG.Required, TAG.Alarm],
            },
            "Overload_Alarm": {"tags": [TAG.Overload, TAG.Alarm],},
            "Power_Alarm": {
                "tags": [TAG.Power, TAG.Alarm],
                "subclasses": {
                    "Power_Loss_Alarm": {"tags": [TAG.Power, TAG.Loss, TAG.Alarm],},
                },
            },
            "Pressure_Alarm": {
            ...
            "Water_Alarm": {
                ...
                "subclasses": {
                    ...
                    "No_Water_Alarm": {"tags": [TAG.No, TAG.Water, TAG.Alarm],},
                    "Water_Loss_Alarm": {"tags": [TAG.Loss, TAG.Water, TAG.Alarm],},
                },
            },
        },
    },
