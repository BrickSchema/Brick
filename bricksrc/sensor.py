        ...
        "subclasses": {
            ...
            "CO2_Sensor": {
                ...
                "subclasses": {
                    ...
                    "CO2_Level_Sensor": {"tags": [TAG.CO2, TAG.Level, TAG.Sensor],},
            ...
            "Demand_Sensor": {"tags": [TAG.Sensor, TAG.Demand],},
            "Dewpoint_Sensor": {
            ...
            "Energy_Sensor": {
                ...
                "subclasses": {"Today_Peak_Energy_Sensor": {},},
            },
            "Enthalpy_Sensor": {
            ...
            "Motion_Sensor": {
                ...
                "subclasses": {"PIR_Sensor": {"tags": [TAG.Sensor, TAG.PIR],}},
            },
            "Occupancy_Sensor": {
                "tags": [TAG.Sensor, TAG.Occupancy],
                "substances": [[BRICK.measures, BRICK.Occupancy]],
                "subclasses": {"PIR_Sensor": {"tags": [TAG.Pir, TAG.Sensor],}},
            },
            ...
            "Duration_Sensor": {
                ...
                "subclasses": {
                    ...
                    "Run_Time_Sensor": {"tags": [TAG.Run, TAG.Time, TAG.Sensor],},
                    "On_Timer_Sensor": {"tags": [TAG.On, TAG.Timer, TAG.Sensor],},
                },
            },
            ...
            "Speed_Sensor": {
                ...
                "subclasses": {
                    ...
                    "Motor_Speed_Sensor": {"tags": [TAG.Motor, TAG.Speed, TAG.Sensor],},
                    "Wind_Speed_Sensor": {
